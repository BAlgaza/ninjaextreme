...
import {
  ...
  Sparkles, LogOut, Trophy, Heart, Loader2, AlertCircle, Ticket,
} from "lucide-react";
...
type ProfileTab = "profile" | "vouchers";
...
const Profile = () => {
  ...
  const tabs: { key: ProfileTab; label: string; icon: React.ReactNode }[] = [
    { key: "profile", label: lang === "id" ? "Profil" : "Profile", icon: <User className="w-3.5 h-3.5" /> },
    { key: "vouchers", label: "Vouchers", icon: <Ticket className="w-3.5 h-3.5" /> },
  ];
